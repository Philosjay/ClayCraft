...
public  class GameObjectHolder : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //BtnForManipulator = GameObject.Find("/Workbench/Canvas").transform.Find("BtnForManipulator").gameObject;
        //Btn_Head = BtnForManipulator.transform.Find("HeadBtn").gameObject;
        //Btn_Body = BtnForManipulator.transform.Find("BodyBtn").gameObject;
        //Btn_LArm = BtnForManipulator.transform.Find("LArmBtn").gameObject;
        //Btn_RArm = BtnForManipulator.transform.Find("RArmBtn").gameObject;
        //Btn_LLeg = BtnForManipulator.transform.Find("LLegBtn").gameObject;
        //Btn_RLeg = BtnForManipulator.transform.Find("RLegBtn").gameObject;
